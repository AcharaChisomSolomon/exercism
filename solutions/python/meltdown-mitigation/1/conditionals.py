...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    ten_percent_less = 0.9 * threshold
    ten_percent_more = 1.1 * threshold

    temp_neutron = temperature * neutrons_produced_per_second
    if temp_neutron < ten_percent_less:
        return "LOW"
    elif temp_neutron >= ten_percent_less and temp_neutron <= ten_percent_more:
        return "NORMAL"
    else:
        return "DANGER"
